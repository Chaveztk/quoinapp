...
import "../../assets/sass/portfolio-two-details.scss";
...
class PortfolioTwo extends Component {
  render() {
    ...
    return (
      <div>
        <div className="portfolio-two-details ltn__page-details-area ltn__portfolio-two-details-area mb-105">
          <Navbar />
          <div className="portfolio-two-details__portfolio-two-header">
            <h5 className="portfolio-two-details__portfolio-two-year">2022</h5>
            <h1 className="portfolio-two-details__portfolio-two-title">
              Portfolio 2
            </h1>
            <h4 className="portfolio-two-details__project-brief">
          ...
          <div className="portfolio-two-details__container container w-100">
            <div className="row">
