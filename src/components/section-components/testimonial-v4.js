  ...
  render() {
    ...
    return (
      <div
        ...
        data-bs-bg={publicUrl + "assets/img/bg/8.jpg"}
      >
        <div className="container">
          ...
          <div className="row ltn__testimonial-slider-2-active slick-arrow-3">
            <div className="col-lg-12">
              <div className="ltn__testimonial-item ltn__testimonial-item-3">
                <div className="ltn__testimonial-img">
                  <img src={publicUrl + "assets/img/blog-grid/4.jpg"} alt="#" />
                </div>
            ...
            <div className="col-lg-12">
              <div className="ltn__testimonial-item ltn__testimonial-item-3">
                <div className="ltn__testimonial-img">
                  <img src={publicUrl + "assets/img/blog-grid/5.jpg"} alt="#" />
                </div>
                <div className="ltn__testimoni-info">
                  <p>
                    Lorem ipsum ctetur elit, sed do eius mod tempor incididunt
            ...
            <div className="col-lg-12">
              <div className="ltn__testimonial-item ltn__testimonial-item-3">
                <div className="ltn__testimonial-img">
                  <img src={publicUrl + "assets/img/blog-grid/6.jpg"} alt="#" />
                </div>
                <div className="ltn__testimoni-info">
                  <p>
                    Lorem ipsum ctetur elit, sed do eius mod tempor incididunt
            ...
            <div className="col-lg-12">
              <div className="ltn__testimonial-item ltn__testimonial-item-3">
                <div className="ltn__testimonial-img">
                  <img src={publicUrl + "assets/img/blog-grid/1.jpg"} alt="#" />
                </div>
                <div className="ltn__testimoni-info">
                  <p>
                    Lorem ipsum ctetur elit, sed do eius mod tempor incididunt
            ...
            <div className="col-lg-12">
              <div className="ltn__testimonial-item ltn__testimonial-item-3">
                <div className="ltn__testimonial-img">
                  <img src={publicUrl + "assets/img/blog-grid/2.jpg"} alt="#" />
                </div>
                <div className="ltn__testimoni-info">
                  <p>
                    Lorem ipsum ctetur elit, sed do eius mod tempor incididunt
