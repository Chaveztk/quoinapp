            ...
            <div className="col-lg-8">
              <div className="ltn__page-details-inner ltn__portfolio-details-inner">
                <div className="ltn__blog-grid-img">
                  <img
                    className="portfolio-details__main-img"
                ...
                <p>
                  {" "}
                  <span className="ltn__first-letter">L</span>orem ipsum dolor
                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="ltn__testimonial-item ltn__testimonial-item-3">
                      <div className="ltn__testimonial-img">
                        <img
                          src={publicUrl + "assets/img/blog-grid/7.jpg"}
                          alt="Image"
                        />
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="ltn__testimonial-item ltn__testimonial-item-3">
                      <div className="ltn__testimonial-img">
                        <img
                          src={publicUrl + "assets/img/blog-grid/8.jpg"}
                          alt="Image"
                        />
                      </div>
                      <div className="ltn__testimoni-info">
