          ...
          <div className="row">
            <div className="col-lg-8 col-md-12">
              <div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
                <div className="ltn__blog-grid-meta">
                  <ul>
                    <li className="ltn__blog-grid-category">
                    ...
                    <li className="ltn__blog-grid-date">
                        ...
                        <div className="real-estate-agent">
                          <div className="agent-img">
                            <Link to="/team-details">
                              <img
                                src={
                                  publicUrl + "assets/img/blog-grid/author.jpg"
                                }
                                alt="#"
                              />
                            </Link>
                            ...
                            <div className="agent-img">
                              <Link to="/team-details">
                                <img
                                  src={
                                    publicUrl +
                                    "assets/img/blog-grid/author.jpg"
                                  }
                                  alt="#"
                                />
                              </Link>
